...
public struct Colour : IColour
{
    ...
    public static Colour GetRandomColour(IRandom randomizer, ValueRange<byte>? alphaRange = null, ValueRange<byte>? redRange = null, ValueRange<byte>? greenRange = null, ValueRange<byte>? blueRange = null)
    {
        ValueRange<byte> actualAlphaRange = alphaRange ?? DefaultRanges.RandomDefaultAlphaRange;
        ValueRange<byte> actualRedRange = redRange ?? DefaultRanges.RandomDefaultRgbColourRange;
        ValueRange<byte> actualGreenRange = greenRange ?? DefaultRanges.RandomDefaultRgbColourRange;
        ValueRange<byte> actualBlueRange = blueRange ?? DefaultRanges.RandomDefaultRgbColourRange;
