...
public struct TslColour : IColour
{
    ...
    public static TslColour GetRandomColour(IRandom randomizer, ValueRange<byte>? alphaRange = null, ValueRange<double>? tintRange = null, ValueRange<double>? saturationRange = null, ValueRange<double>? lightnessRange = null)
    {
        ValueRange<byte> actualAlphaRange = alphaRange ?? DefaultRanges.RandomDefaultAlphaRange;
        ValueRange<double> actualTintRange = tintRange ?? DefaultRanges.DoublePercentageRange;
        ValueRange<double> actualSaturationRange = saturationRange ?? DefaultRanges.DoublePercentageRange;
        ValueRange<double> actualLightnessRange = lightnessRange ?? DefaultRanges.DoublePercentageRange;
