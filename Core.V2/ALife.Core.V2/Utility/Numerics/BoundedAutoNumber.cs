...
namespace ALife.Core.Utility
{
    ...
    /// </summary>
    public class BoundedAutoNumber
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundedAutoNumber"/> class.
        /// </summary>
        /// <param name="value">The starting value.</param>
        /// <param name="minValue">The minimum value.</param>
        /// <param name="maxValue">The maximum value.</param>
        public BoundedAutoNumber(double value, double minValue = double.MinValue, double maxValue = double.MaxValue)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundedAutoNumber"/> class by copying the values from the parent.
        /// </summary>
        /// <param name="parent">The parent.</param>
        public BoundedAutoNumber(BoundedAutoNumber parent)
        {
            Value = parent.Value;
