...
namespace ALife.Core.Utility.Numerics
{
    ...
    public struct DeltaBoundedNumber : IDeepCloneable<DeltaBoundedNumber>, IEquatable<DeltaBoundedNumber>
    {
        /// <summary>
        /// The delta maximum
        /// </summary>
        ...
        public double Value
        {
            ...
            set => _value = ExtraMath<double>.DeltaClamp(value, _value, -DeltaMaxValue, DeltaMaxValue, DeltaAbsoluteMinimumValue, DeltaAbsoluteMaximumValue);
        }
        ...
        {
            return obj is DeltaBoundedNumber number && Equals(number);
        }
        ...
        /// <summary>
        /// Determines whether the specified <see cref="DeltaBoundedNumber"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The other instance.</param>
        /// <returns>True if equals, False otherwise.</returns>
        public bool Equals(DeltaBoundedNumber other)
        {
            return _deltaMaximum.Equals(other._deltaMaximum) && _value.Equals(other._value);
        }
    }
}