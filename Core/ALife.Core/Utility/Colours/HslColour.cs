...
namespace ALife.Core.Utility.Colours
{
    ...
    public struct HslColour : IColour
    {
        ...
        {
            return new HslColour(alpha, hue, saturation, lightness, false);
        }
        ...
        public static HslColour FromAHSV(byte alpha, int hue, double saturation, double value)
        {
            ...
            ColourHelpers.ConvertRgbToHsl(r, g, b, out hue, out saturation, out var lightness);
            return FromAHSL(alpha, hue, saturation, lightness);
        }
        ...
        {
            ColourHelpers.ConvertRgbToHsl(red, green, blue, out var hue, out var saturation, out var lightness);
            return FromAHSL(alpha, hue, saturation, lightness);
        }
        ...
        /// <summary>
        /// Creates a HslColour object from the specified HSL value.
        /// </summary>
        /// <param name="hue">The hue.</param>
        /// <param name="saturation">The saturation.</param>
        /// <param name="lightness">The lightness.</param>
        ...
        /// <summary>
        /// Creates a HslColour object from the specified HSV value.
        /// </summary>
        /// <param name="hue">The hue.</param>
        /// <param name="saturation">The saturation.</param>
        /// <param name="value">The value.</param>
