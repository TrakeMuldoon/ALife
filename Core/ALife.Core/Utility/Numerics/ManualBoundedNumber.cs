...
public struct ManualBoundedNumber : IDeepCloneable<ManualBoundedNumber>, IEquatable<ManualBoundedNumber>
{
    /// <summary>
    /// The range
    /// </summary>
    ...
    {
        return obj is ManualBoundedNumber number && Equals(number);
    }
    ...
    public bool Equals(ManualBoundedNumber other)
    {
