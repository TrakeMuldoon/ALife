...
namespace ALifeUni
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if(e.PrelaunchActivated == false)
            {
                if(rootFrame.Content == null)
                {
                    ...
                    _ = rootFrame.Navigate(typeof(Launcher), e.Arguments);
                }
        ...
        /// <summary>
        /// Invoked when application execution is being suspended. Application state is saved without knowing whether
        /// the application will be terminated or resumed with the contents of memory still intact.
        /// </summary>
