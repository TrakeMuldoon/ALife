...
{
    /// <summary>
    /// A small constant value used for numerical comparisons to account for floating-point precision errors.
    /// </summary>
    ...
    {
        Matrix output = new() { M11 = 1, M22 = 1, M33 = 1, M41 = x, M42 = y, M43 = z, M44 = 1 };
    ...
    public override bool Equals(object obj)
    {
        return obj is Matrix mat &&
          Math.Abs(M11 - mat.M11) < Epsilon &&
          Math.Abs(M12 - mat.M12) < Epsilon &&
          Math.Abs(M13 - mat.M13) < Epsilon &&
          Math.Abs(M14 - mat.M14) < Epsilon &&
          Math.Abs(M21 - mat.M21) < Epsilon &&
          Math.Abs(M22 - mat.M22) < Epsilon &&
          Math.Abs(M23 - mat.M23) < Epsilon &&
          Math.Abs(M24 - mat.M24) < Epsilon &&
          Math.Abs(M31 - mat.M31) < Epsilon &&
          Math.Abs(M32 - mat.M32) < Epsilon &&
          Math.Abs(M33 - mat.M33) < Epsilon &&
          Math.Abs(M34 - mat.M34) < Epsilon &&
          Math.Abs(M41 - mat.M41) < Epsilon &&
          Math.Abs(M42 - mat.M42) < Epsilon &&
          Math.Abs(M43 - mat.M43) < Epsilon &&
          Math.Abs(M44 - mat.M44) < Epsilon;
    }
