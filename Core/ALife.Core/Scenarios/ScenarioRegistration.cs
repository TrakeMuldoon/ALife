namespace ALife.Core.Scenarios
{
    ...
    public class ScenarioRegistration : Attribute
    {
        ...
        /// </summary>
        public readonly ScenarioAutoStartMode AutoStartScenario;

        /// <summary>
        /// The automatic start seed, used only if AutoStartScenario is configured to a value other than None.
        /// </summary>
        ...
        public ScenarioRegistration(string name, string description, bool debugModeOnly = false, ScenarioAutoStartMode autoStartScenario = ScenarioAutoStartMode.None, int autoStartSeed = int.MinValue)
        {
            Name = name;
            Description = description;
            DebugModeOnly = debugModeOnly;
            AutoStartScenario = autoStartScenario;
            int? actualSeed = autoStartSeed;
            if(AutoStartScenario == ScenarioAutoStartMode.None && autoStartSeed == int.MinValue)
            {
                actualSeed = null;
            }
