...
namespace ALife.Core.Utility.Numerics
{
    ...
    public struct BoundedNumber : IDeepCloneable<BoundedNumber>, IEquatable<BoundedNumber>
    {
        /// <summary>
        /// The range
        /// </summary>
        ...
        {
            return obj is BoundedNumber number && Equals(number);
        }
        ...
        /// <summary>
        /// Determines whether the specified <see cref="BoundedNumber"/>, is equal to this instance.
        /// </summary>
        /// <param name="other">The other instance.</param>
        /// <returns>True if equals, False otherwise.</returns>
        public bool Equals(BoundedNumber other)
        {
