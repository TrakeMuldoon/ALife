...
{
    /// <summary>
    /// The default scenario runner config used for scenarios that do not have a specific config
    /// </summary>
    /// <seealso cref="ALife.Core.ScenarioRunners.ScenarioRunnerConfigs.AbstractScenarionRunnerConfig" />
