...
namespace ALife.Core.WorldInfoObjects.Colours
{
    ...
    public struct HsvColour : IColour
    {
        ...
        public static HsvColour GetRandomColour(IRandom randomizer, ValueRange<byte>? alphaRange = null, ValueRange<int>? hueRange = null, ValueRange<double>? saturationRange = null, ValueRange<double>? valueRange = null)
        {
            ...
            ValueRange<double> actualValueRange = valueRange ?? DefaultRanges.DoublePercentageRange;
