...
public static class EvoNumberExtensions
{
    ...
    public static IEvoNumber Evolve(this IEvoNumber number, IRandom randomGenerator)
    {
        ...
        BoundedNumber newMinimum = new(newMinimumValue, number.ValueMinimum.Minimum, double.MaxValue);
        ...
        BoundedNumber newMaximum = new(newMaximumValue, double.MinValue, number.ValueMaximum.Maximum);
        ...
        DeltaBoundedNumber newValueDelta = new(newValueDeltaMaximum, number.ValueDeltaMaximum.DeltaMaxValue, 0, number.ValueDeltaMaximum.DeltaAbsoluteMaximumValue);
    ...
    private static IEvoNumber GetEvoNumber(Type type, double newOriginalValue, double originalValueEvolutionDeltaMax, BoundedNumber newMinimum, BoundedNumber newMaximum, double valueMaximumAndMinimumEvolutionDeltaMax, DeltaBoundedNumber newValueDelta)
    {
        switch(type)
        {
            case { } t when t == typeof(EvoNumber):
            ...
            case { } t when t == typeof(ReadOnlyEvoNumber):
