...
public struct CircularBoundedNumber : IDeepCloneable<CircularBoundedNumber>, IEquatable<CircularBoundedNumber>
{
    /// <summary>
    /// The range
    /// </summary>
    [JsonIgnore]
    private ValueRange<double> _range;
    ...
    {
        _range = new ValueRange<double>(minimum, maximum);
    ...
    {
        return obj is CircularBoundedNumber number && Equals(number);
    }
    ...
    /// <summary>
    /// Determines whether the specified <see cref="CircularBoundedNumber"/> is equal to this instance.
    /// </summary>
    /// <param name="other">The other instance.</param>
    /// <returns>True if equals, False otherwise.</returns>
    public bool Equals(CircularBoundedNumber other)
    {
        return _range.Equals(other._range) && _value.Equals(other._value);
    }
}
