...
namespace ALife.Core.WorldInfoObjects.Colours
{
    ...
    public struct HslColour : IColour
    {
        ...
        public static HslColour GetRandomColour(IRandom randomizer, ValueRange<byte>? alphaRange = null, ValueRange<int>? hueRange = null, ValueRange<double>? saturationRange = null, ValueRange<double>? lightnessRange = null)
        {
            ValueRange<byte> actualAlphaRange = alphaRange ?? DefaultRanges.RandomDefaultAlphaRange;
            ValueRange<int> actualHueRange = hueRange ?? DefaultRanges.DegreeRange;
